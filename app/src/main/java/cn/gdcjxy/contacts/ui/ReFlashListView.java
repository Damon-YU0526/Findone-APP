...
public class ReFlashListView extends ListView implements AbsListView.OnScrollListener {
    ...
    boolean isRemark;// flag；
    int startY;

    int state;// state；
    final int NONE = 0;// NONE；
    final int PULL = 1;// pull；
    final int RELESE = 2;// RELESE；
    final int REFLASHING = 3;// REFLASHING；
    IReflashListener iReflashListener;// iReflashListener
    ...
    private void reflashViewByState() {
        ...
        switch (state) {
            ...
            case PULL:
                ...
                tip.setText("Scroll down to refresh！");
                arrow.clearAnimation();
