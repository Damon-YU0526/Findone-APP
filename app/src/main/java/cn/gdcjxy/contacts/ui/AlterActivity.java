    ...
    private void initView() {
        ...
        button_alter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dao.update(c); // update database
                Toast.makeText(AlterActivity.this,"update success",Toast.LENGTH_SHORT).show();
        ...
        button_del.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dao.delete(id);
                Toast.makeText(AlterActivity.this,"delete success",Toast.LENGTH_SHORT).show();
                startActivity(new Intent(AlterActivity.this, MainActivity.class));
            }
        });
    }
